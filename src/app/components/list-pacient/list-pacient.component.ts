...
@Component({
  ...
  imports: [FontAwesomeModule, GenericFormComponent, CommonModule, RouterModule, ReactiveFormsModule, SearchComponentComponent, ToastModule],
